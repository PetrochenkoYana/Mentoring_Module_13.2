...
{
    class Order_DetailsSerializationSurrogate : ISerializationSurrogate
    {
        public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
        {
            ...
            {
                dbContext.LoadProperty(orderDetail, o => o.Order);
                dbContext.LoadProperty(orderDetail, o => o.Product);
            }
